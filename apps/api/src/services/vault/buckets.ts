...
export const BUCKET_DEFINITIONS: Record<CredentialBucket, BucketDefinition> = {
  ...
  digest_auth: {
    bucket: "digest_auth",
    displayName: "Digest / Session Auth",
    description: "Digest authentication (RFC 7616) and session cookie / token based authentication.",
    sensitiveFieldNames: ["password", "secret", "sessionCookie", "cookie"],
    fields: [
      {
        name: "username",
  ...
  custom_headers: {
    ...
    displayName: "Custom Headers & Cookies",
    description: "Arbitrary custom headers, authentication tokens, and session cookies for proprietary integrations.",
    sensitiveFieldNames: ["headers", "cookies", "secret", "value"],
    fields: [
      {
        name: "headers",
        label: "Custom Headers (JSON or key:value lines)",
        type: "textarea",
        required: true,
        sensitive: true,
      ...
      {
        name: "cookies",
        label: "Cookies / Session String",
        type: "textarea",
        required: false,
        sensitive: true,
        placeholder: "token=xyz; session=abc",
      },
    ],
  },
  ...
  aws_iam: {
    bucket: "aws_iam",
    displayName: "AWS IAM / SigV4 Signing",
    description: "AWS Signature Version 4 (SigV4) request signing using Access Key ID and Secret Access Key.",
    sensitiveFieldNames: ["secretAccessKey", "sessionToken", "secretKey"],
    fields: [
      {
        name: "accessKeyId",
      ...
      },
      {
        ...
        placeholder: "us-east-1, eu-west-1, sa-east-1",
      },
      {
        name: "service",
        ...
        placeholder: "execute-api, s3, bedrock, sqs, lambda",
      },
      {
        name: "sessionToken",
        label: "AWS Session Token (STS)",
        type: "password",
        required: false,
        sensitive: true,
        placeholder: "FwoGZXIvYXdzEAEa...",
      },
    ],
  },
  ...
  certificate_auth: {
    ...
    displayName: "SSL/TLS Client Certificate (mTLS)",
    description: "Mutual TLS authentication using client PEM/CRT certificates, private keys, and custom CA bundles.",
    sensitiveFieldNames: ["cert", "certificate", "key", "privateKey", "passphrase", "ca"],
    fields: [
      {
        name: "cert",
      ...
      {
        name: "ca",
        label: "Custom CA Certificate Bundle",
        type: "textarea",
        required: false,
        sensitive: true,
        placeholder: "-----BEGIN CERTIFICATE-----\n...\n-----END CERTIFICATE-----",
  ...
  database_connection: {
    bucket: "database_connection",
    displayName: "Database Connection",
    description: "Database connection parameters for PostgreSQL, MySQL, Redis, MongoDB, MSSQL, Oracle with connection pooling.",
    sensitiveFieldNames: ["password", "secret", "connectionString", "uri"],
    fields: [
      {
        name: "type",
        ...
        options: [
          ...
          { value: "redis", label: "Redis / Valkey" },
      ...
      },
      {
        ...
        required: false,
        sensitive: false,
        placeholder: "localhost or db.provider.com",
      },
      {
        name: "port",
        label: "Port",
        ...
        required: false,
        sensitive: false,
        placeholder: "5432, 3306, 6379, 27017, 1433, 1521",
      },
      {
        name: "database",
        label: "Database Name",
