              ...
              <div className="relative">
                ...
                {profileOpen ? (
                  <div className="absolute bottom-full left-0 mb-1 max-h-80 w-56 overflow-y-auto rounded-lg border border-white/10 bg-zinc-900 p-1 shadow-2xl shadow-black/40">
                    ...
                    <button type="button" onClick={() => setProfileOpen(false)} className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-sm text-zinc-300 hover:bg-white/5 hover:text-zinc-100"><Settings className="h-4 w-4 text-zinc-500" /> Instance-level MCP</button>
